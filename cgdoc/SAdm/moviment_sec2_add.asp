...
if useAJAX then
	includes=includes & "var AUTOCOMPLETE_TABLE='moviment_sec2_autocomplete.asp';" & vbcrlf
	includes=includes & "var SUGGEST_TABLE='moviment_sec2_searchsuggest.asp';" & vbcrlf
	includes=includes & "var SUGGEST_LOOKUP_TABLE='moviment_sec2_lookupsuggest.asp';" & vbcrlf
end if
...
smarty_display("moviment_sec2_add.htm")

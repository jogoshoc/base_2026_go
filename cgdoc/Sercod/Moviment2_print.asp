...
'//	PastaArquiv - 
	value=""
				value = ProcessLargeText(GetData(rs,"PastaArquiv", ""),"field=PastaArquiv" & keylink,"",MODE_PRINT)
...
'//	include proper masterprint.php code%>
	<!--#include file="include/Tramitacao_masterprint.asp"-->
	<%
	...
	smarty.Add "showmasterfile","Tramitacao_masterprint.htm"
end if

strSQL=SESSION(strTableName & "_sql")
smarty_display("Moviment2_print.htm")
%>
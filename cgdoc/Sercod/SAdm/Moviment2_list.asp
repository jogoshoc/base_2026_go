...
if useAJAX then
	includes = includes & "var SUGGEST_TABLE = ""Moviment2_searchsuggest.asp"";" & vbCrLf
	includes = includes & "var MASTER_PREVIEW_TABLE = ""Moviment2_masterpreview.asp"";" & vbCrLf
end if
...
'	write pagination
smarty.Add "pagination","<script language=""JavaScript"">WritePagination(" & mypage & "," & maxpages & ");function GotoPage(nPageNumber){window.location='Moviment2_list.asp?goto='+nPageNumber;}</script>"
...
%>
	<!--#include file="include/Tramitacao_masterlist.asp"-->
	<%
	masterkeys.Add i,SESSION(strTableName & "_masterkey1")
	i=i+1
	DisplayMasterTableInfo "Moviment2", masterkeys
	AddDict smarty,"showmasterfile","Tramitacao_masterlist.htm"
end if


strSQL=SESSION(strTableName & "_sql")

smarty_display("Moviment2_list.htm")

...
includes=includes & "	document.getElementById('second_Nat').style.display =  "
includes=includes & "	document.forms.editform.elements['asearchopt_Nat'].value=='Between' ? '' : 'none';" & vbcrlf
...
includes=includes & "	document.getElementById('second_Destino').style.display =  "
includes=includes & "	document.forms.editform.elements['asearchopt_Destino'].value=='Between' ? '' : 'none';" & vbcrlf
includes=includes & "	document.getElementById('second_TipoDoc').style.display =  "
includes=includes & "	document.forms.editform.elements['asearchopt_TipoDoc'].value=='Between' ? '' : 'none';" & vbcrlf
...
includes=includes & "	document.getElementById('second_CPF').style.display =  "
includes=includes & "	document.forms.editform.elements['asearchopt_CPF'].value=='Between' ? '' : 'none';" & vbcrlf
includes=includes & "	document.getElementById('second_MASP').style.display =  "
includes=includes & "	document.forms.editform.elements['asearchopt_MASP'].value=='Between' ? '' : 'none';" & vbcrlf
includes=includes & "	document.getElementById('second_Obs').style.display =  "
includes=includes & "	document.forms.editform.elements['asearchopt_Obs'].value=='Between' ? '' : 'none';" & vbcrlf
...
if useAJAX then
	...
	includes=includes &	"document.forms.editform.value_CPF.onkeyup=function(event) {searchSuggest(event,document.forms.editform.value_CPF,'advanced')};" & vbcrlf
	includes=includes & "document.forms.editform.value1_CPF.onkeyup=function(event) {searchSuggest(event,document.forms.editform.value1_CPF,'advanced1')};" & vbcrlf
	includes=includes &	"document.forms.editform.value_CPF.onkeydown=function(event) {return listenEvent(event,document.forms.editform.value_CPF,'advanced')};" & vbcrlf
	includes=includes &	"document.forms.editform.value1_CPF.onkeydown=function(event) {return listenEvent(event,document.forms.editform.value1_CPF,'advanced1')};" & vbcrlf	
	
	includes=includes &	"document.forms.editform.value_MASP.onkeyup=function(event) {searchSuggest(event,document.forms.editform.value_MASP,'advanced')};" & vbcrlf
	includes=includes & "document.forms.editform.value1_MASP.onkeyup=function(event) {searchSuggest(event,document.forms.editform.value1_MASP,'advanced1')};" & vbcrlf
	includes=includes &	"document.forms.editform.value_MASP.onkeydown=function(event) {return listenEvent(event,document.forms.editform.value_MASP,'advanced')};" & vbcrlf
	includes=includes &	"document.forms.editform.value1_MASP.onkeydown=function(event) {return listenEvent(event,document.forms.editform.value1_MASP,'advanced1')};" & vbcrlf	
...
'//	edit format
editformats.Add "NrProtoc","Lookup wizard"
'// DtEntr 
...
opt=""
if SESSION(strTableName & "_search")=2 then
	opt=strTableName_asearchopt.Item("Nat")
	nnot=strTableName_asearchnot.Item("Nat")
	smarty.Add "value_Nat",strTableName_asearchfor.Item("Nat")
	smarty.Add "value1_Nat",strTableName_asearchfor2.Item("Nat")
end if
	
if nnot<>"" then smarty.Add "not_Nat"," checked"
'//	write search options
options=""
s=""
if opt="Equals" then s="selected"
options=options & "<OPTION VALUE=""Equals"" " & s & ">" & "Igual a" & "</option>"
searchtype = "<SELECT ID=""SearchOption"" NAME=""asearchopt_Nat"" SIZE=1 onChange=""return ShowHideControls();"">"
searchtype = searchtype & options
searchtype = searchtype & "</SELECT>"
smarty.Add "searchtype_Nat",searchtype
'//	edit format
editformats.Add "Nat","Radio button"
'// Emissor 
...
'//	edit format
editformats.Add "Emissor","Lookup wizard"
'// Destino 
...
opt=""
if SESSION(strTableName & "_search")=2 then
	opt=strTableName_asearchopt.Item("Destino")
	nnot=strTableName_asearchnot.Item("Destino")
	smarty.Add "value_Destino",strTableName_asearchfor.Item("Destino")
	smarty.Add "value1_Destino",strTableName_asearchfor2.Item("Destino")
end if
	
if nnot<>"" then smarty.Add "not_Destino"," checked"
'//	write search options
options=""
s=""
if opt="Equals" then s="selected"
options=options & "<OPTION VALUE=""Equals"" " & s & ">" & "Igual a" & "</option>"
searchtype = "<SELECT ID=""SearchOption"" NAME=""asearchopt_Destino"" SIZE=1 onChange=""return ShowHideControls();"">"
searchtype = searchtype & options
searchtype = searchtype & "</SELECT>"
smarty.Add "searchtype_Destino",searchtype
'//	edit format
editformats.Add "Destino","Lookup wizard"
'// TipoDoc 
...
opt=""
if SESSION(strTableName & "_search")=2 then
	opt=strTableName_asearchopt.Item("TipoDoc")
	nnot=strTableName_asearchnot.Item("TipoDoc")
	smarty.Add "value_TipoDoc",strTableName_asearchfor.Item("TipoDoc")
	smarty.Add "value1_TipoDoc",strTableName_asearchfor2.Item("TipoDoc")
end if
	
if nnot<>"" then smarty.Add "not_TipoDoc"," checked"
'//	write search options
options=""
s=""
if opt="Equals" then s="selected"
options=options & "<OPTION VALUE=""Equals"" " & s & ">" & "Igual a" & "</option>"
searchtype = "<SELECT ID=""SearchOption"" NAME=""asearchopt_TipoDoc"" SIZE=1 onChange=""return ShowHideControls();"">"
searchtype = searchtype & options
searchtype = searchtype & "</SELECT>"
smarty.Add "searchtype_TipoDoc",searchtype
'//	edit format
editformats.Add "TipoDoc","Lookup wizard"
'// Descr 
...
opt=""
if SESSION(strTableName & "_search")=2 then
	opt=strTableName_asearchopt.Item("CPF")
	nnot=strTableName_asearchnot.Item("CPF")
	smarty.Add "value_CPF",strTableName_asearchfor.Item("CPF")
	smarty.Add "value1_CPF",strTableName_asearchfor2.Item("CPF")
end if
	
if nnot<>"" then smarty.Add "not_CPF"," checked"
'//	write search options
options=""
s=""
if opt="Contains" then s="selected"
...
if opt="Empty" then s="selected"
options=options & "<OPTION VALUE=""Empty"" " & s & ">" & "Vazio" & "</option>"
searchtype = "<SELECT ID=""SearchOption"" NAME=""asearchopt_CPF"" SIZE=1 onChange=""return ShowHideControls();"">"
searchtype = searchtype & options
searchtype = searchtype & "</SELECT>"
smarty.Add "searchtype_CPF",searchtype
'//	edit format
editformats.Add "CPF","Text field"
...
opt=""
if SESSION(strTableName & "_search")=2 then
	opt=strTableName_asearchopt.Item("MASP")
	nnot=strTableName_asearchnot.Item("MASP")
	smarty.Add "value_MASP",strTableName_asearchfor.Item("MASP")
	smarty.Add "value1_MASP",strTableName_asearchfor2.Item("MASP")
end if
	
if nnot<>"" then smarty.Add "not_MASP"," checked"
'//	write search options
options=""
s=""
if opt="Contains" then s="selected"
...
if opt="Empty" then s="selected"
options=options & "<OPTION VALUE=""Empty"" " & s & ">" & "Vazio" & "</option>"
searchtype = "<SELECT ID=""SearchOption"" NAME=""asearchopt_MASP"" SIZE=1 onChange=""return ShowHideControls();"">"
searchtype = searchtype & options
searchtype = searchtype & "</SELECT>"
smarty.Add "searchtype_MASP",searchtype
'//	edit format
editformats.Add "MASP","Text field"
...
opt=""
if SESSION(strTableName & "_search")=2 then
	opt=strTableName_asearchopt.Item("Obs")
	nnot=strTableName_asearchnot.Item("Obs")
	smarty.Add "value_Obs",strTableName_asearchfor.Item("Obs")
	smarty.Add "value1_Obs",strTableName_asearchfor2.Item("Obs")
end if
	
if nnot<>"" then smarty.Add "not_Obs"," checked"
'//	write search options
options=""
s=""
if opt="Contains" then s="selected"
...
if opt="Empty" then s="selected"
options=options & "<OPTION VALUE=""Empty"" " & s & ">" & "Vazio" & "</option>"
searchtype = "<SELECT ID=""SearchOption"" NAME=""asearchopt_Obs"" SIZE=1 onChange=""return ShowHideControls();"">"
searchtype = searchtype & options
searchtype = searchtype & "</SELECT>"
smarty.Add "searchtype_Obs",searchtype
'//	edit format
editformats.Add "Obs",EDIT_FORMAT_TEXT_FIELD
...
smarty_display("Cadastro_search.htm")

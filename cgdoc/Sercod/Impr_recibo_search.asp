...
if useAJAX then
	includes=includes & "var SUGGEST_TABLE = ""Impr_recibo_searchsuggest.asp""" & vbcrlf
	includes=includes & "var SUGGEST_LOOKUP_TABLE=""Impr_recibo_lookupsuggest.asp""" & vbcrlf
	includes=includes & "var AUTOCOMPLETE_TABLE=""Impr_recibo_autocomplete.asp""" & vbcrlf
end if
...
if useAJAX then
	...
	includes=includes &	"document.forms.editform.value_Destino.onkeyup=function(event) {searchSuggest(event,document.forms.editform.value_Destino,'advanced')};" & vbcrlf
	includes=includes & "document.forms.editform.value1_Destino.onkeyup=function(event) {searchSuggest(event,document.forms.editform.value1_Destino,'advanced1')};" & vbcrlf
	includes=includes &	"document.forms.editform.value_Destino.onkeydown=function(event) {return listenEvent(event,document.forms.editform.value_Destino,'advanced')};" & vbcrlf
	includes=includes &	"document.forms.editform.value1_Destino.onkeydown=function(event) {return listenEvent(event,document.forms.editform.value1_Destino,'advanced1')};" & vbcrlf
...
'//	edit format
editformats.Add "Destino","Text field"
'// NrProtoc 
...
smarty_display("Impr_recibo_search.htm")

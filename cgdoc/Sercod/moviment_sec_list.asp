...
if useAJAX then
	...
	includes = includes & "var MASTER_PREVIEW_TABLE = ""moviment_sec_masterpreview.asp"";" & vbCrLf
end if
...
'	write pagination
smarty.Add "pagination","<script language=""JavaScript"">WritePagination(" & mypage & "," & maxpages & ");function GotoPage(nPageNumber){window.location='moviment_sec_list.asp?goto='+nPageNumber;}</script>"
...
%>
	...
	i=i+1
	DisplayMasterTableInfo "moviment_sec", masterkeys
...
smarty_display("moviment_sec_list.htm")
